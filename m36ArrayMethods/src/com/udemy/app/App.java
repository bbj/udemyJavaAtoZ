...
public class App {
	...
	public static void main(String[] args) {
		...
		/*
		Original array: [10, 5, 20, 33, 11]
		Sorted array:   [5, 10, 11, 20, 33]
		The searched element is in the array, at the position: 4
		[77, 77, 77, 77, 77]
		...
		Arrays.sort(numbers); // sort() method !!! using dual pivot Quicksort O(n log(n)) for primitive types
		System.out.println("Sorted array:   " + Arrays.toString(numbers));

		String[] names = { "bruno", "john", "eric", "albert" };
		Arrays.sort(names); //merge sort - nlogn - as objects
